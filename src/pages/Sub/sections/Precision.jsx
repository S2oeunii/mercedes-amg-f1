...
const Precision = () => {
  ...
  const ref1954    = useRef(null)
  const ref1968    = useRef(null)
  const ref2010    = useRef(null)

  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      // 1954: 우 → 좌, 1968: 좌 → 우, 2010: 우 → 좌
      const items = [
        { ref: ref1954, fromX:  120 },
        { ref: ref1968, fromX: -120 },
        { ref: ref2010, fromX:  120 },
      ]

      items.forEach(({ ref, fromX }) => {
        gsap.fromTo(
          ref.current,
          { opacity: 0, x: fromX },
          {
  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      >
        ...
        <div
          ref={ref1954}
          className='sm:absolute sm:top-[13.85vw] sm:left-[16.30vw]
        ...
        <div
          ref={ref1968}
          className='sm:absolute sm:top-[38.85vw] sm:right-[21.15vw]
        ...
        {/* 2010 ~ Present — 우측에서 슬라이드인 */}
        <div
          ref={ref2010}
          className='sm:absolute sm:top-[77.29vw] sm:left-[20.10vw]
              w-full sm:w-auto items-end flex flex-col gap-[22px] sm:gap-[1.46vw]'
        >
